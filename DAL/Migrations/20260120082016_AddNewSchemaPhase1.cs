...
{
    /// <inheritdoc />
    public partial class AddNewSchemaPhase1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdminLogId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthProviderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlatformRevenueId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TotalGross = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlatformRevenues", x => x.PlatformRevenueId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DestinationImageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DestinationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Url = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Caption = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
